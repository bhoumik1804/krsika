 ...
 * Purchase Validators
 * ====================
 * Zod schemas for purchase validation
 */
import { z } from 'zod'
...
export const createPurchaseSchema = z.object({
    body: z.object({
        ...
        transporterId: z
            ...
            .optional()
            .nullable(),
        stockType: z.enum(['PADDY', 'RICE', 'GUNNY', 'FRK', 'OTHER'], {
...
export const updatePurchaseSchema = z.object({
    body: z.object({
        ...
        transporterId: z
            ...
            .nullable(),
        stockType: z
            .enum(['PADDY', 'RICE', 'GUNNY', 'FRK', 'OTHER'])
            .optional(),
...
/**
 * Query params for listing purchases
 */
export const listPurchasesQuerySchema = z.object({
    query: z.object({
        ...
        limit: z.coerce
            ...
            .optional(),
        sortBy: z
            .enum(['purchaseDate', 'invoiceNumber', 'totalAmount', 'createdAt'])
