...
interface ComboboxProps extends React.ComponentPropsWithoutRef<
    typeof ComboboxPrimitive.Root
> {
    items?: string[]
}

// Base UI Combobox doesn't support ref forwarding, so we use a simple wrapper
const Combobox = ({ items, ...props }: ComboboxProps) => (
