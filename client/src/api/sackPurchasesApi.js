...
export const fetchSackPurchases = async ({
  page = 1,
  pageSize = 10,
  filters = [],
  sorting = [],
...
export const deleteSackPurchase = async (id) => {
  return await apiClient.delete(`/purchases/sack/${id}`);
};

export const updateSackPurchase = async ({ id, ...data }) => {
  return await apiClient.put(`/purchases/sack/${id}`, data);
};
