...
import { FinancialReceiptMultiDeleteDialog } from './financial-receipt-multi-delete-dialog'
...
export function DataTableBulkActions<TData>({
    ...
    const handleBulkStatusChange = (status: 'completed' | 'cancelled') => {
        const selectedRecords = selectedRows.map(
            (row) => row.original as FinancialReceipt
        )
    ...
    return (
        <>
            ...
            <FinancialReceiptMultiDeleteDialog
                table={table}
