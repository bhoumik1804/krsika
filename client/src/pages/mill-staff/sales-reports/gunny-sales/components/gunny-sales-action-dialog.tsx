        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className='max-h-[90vh] max-w-4xl overflow-y-auto'>
                <DialogHeader>
                    <DialogTitle>
                        {isEditing
                            ? t('gunnySales.form.editTitle')
                            : t('gunnySales.form.addTitle')}
                    </DialogTitle>
                    <DialogDescription>
                        {isEditing
                            ? t('gunnySales.form.editDescription')
                            : t('gunnySales.form.addDescription')}
                    </DialogDescription>
                </DialogHeader>
                <Form {...form}>
                    <form
                    ...
                    >
                                                    ...
                                                    <FormControl>
                                                        ...
                                                        >
                                                            ...
                                                            {field.value
                                                                ...
                                                                : t(
                                                                      'gunnySales.form.placeholders.date'
                                                                  )}
                                                        </Button>
                                                    </FormControl>
                                                </PopoverTrigger>
                                        ...
                                        <FormItem>
                                            ...
                                            <FormControl>
                                                <PaginatedCombobox
                                                    ...
                                                    paginatedList={party}
                                                    placeholder={t(
                                                        'gunnySales.form.placeholders.party'
                                                    )}
                                                    emptyText={t(
                                                        'gunnySales.form.placeholders.noResults'
                                                    )}
                                                />
                                            </FormControl>
                                            <FormMessage />
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            <FormLabel>
                                                {t(
                                                    'gunnySales.form.plasticGunnyQty'
                                                )}
                                            </FormLabel>
                                            <FormControl>
                                                <Input
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            <FormLabel>
                                                {t(
                                                    'gunnySales.form.plasticGunnyRate'
                                                )}
                                            </FormLabel>
                                            <FormControl>
                                                <Input
                        ...
                        <DialogFooter>
                            <Button
                                ...
                                disabled={isLoading}
                            >
                                {t('gunnySales.form.buttons.cancel')}
                            </Button>
                            <Button type='submit' disabled={isLoading}>
                                {isLoading
                                    ? isEditing
                                        ? t('gunnySales.form.buttons.updating')
                                        : t('gunnySales.form.buttons.adding')
                                    : isEditing
                                      ? t('gunnySales.form.buttons.update')
                                      : t('gunnySales.form.buttons.add')}
                            </Button>
                        </DialogFooter>
                    </form>
                </Form>
