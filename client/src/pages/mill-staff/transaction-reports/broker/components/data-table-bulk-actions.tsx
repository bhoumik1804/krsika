...
import { BrokerTransactionMultiDeleteDialog } from './broker-transaction-multi-delete-dialog'
...
export function DataTableBulkActions<TData>({
    ...
    const handleBulkStatusChange = (status: 'completed' | 'cancelled') => {
        const selectedPurchases = selectedRows.map(
            (row) => row.original as BrokerTransaction
        )
        toast.promise(sleep(2000), {
            ...
            success: () => {
                ...
                return t('common.markedAs', {
                    ...
                    item: selectedPurchases.length > 1 ? t('common.purchases') : t('common.purchase'),
                    status: status === 'completed' ? t('common.completed') : t('common.cancelled')
                })
            },
    ...
    return (
        <>
            ...
            <BrokerTransactionMultiDeleteDialog
                table={table}
