        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className='max-h-[90vh] max-w-3xl overflow-y-auto'>
                <DialogHeader>
                    <DialogTitle>
                        {isEditing
                            ? t('outward.govtRiceOutward.form.title', {
                                  context: 'edit',
                              })
                            : t('outward.govtRiceOutward.form.title', {
                                  context: 'add',
                    ...
                    <DialogDescription>
                        {t('outward.govtRiceOutward.form.description')}
                    </DialogDescription>
                </DialogHeader>
                <Form {...form}>
                    <form
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel>
                                            {t(
                                                'outward.govtRiceOutward.form.fields.date'
                                            )}
                                        </FormLabel>
                                        <Popover
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel>
                                            {t(
                                                'outward.govtRiceOutward.form.fields.lotNo'
                                            )}
                                        </FormLabel>
                                        <FormControl>
                                            <Input
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel>
                                            {t(
                                                'outward.govtRiceOutward.form.fields.fciNan'
                                            )}
                                        </FormLabel>
                                        <FormControl>
                                            <Select
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel>
                                            {t(
                                                'outward.govtRiceOutward.form.fields.riceType'
                                            )}
                                        </FormLabel>
                                        <Select
                                            onValueChange={field.onChange}
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel>
                                            {t(
                                                'outward.govtRiceOutward.form.fields.gunnyNew'
                                            )}
                                        </FormLabel>
                                        <FormControl>
                                            <Input
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel>
                                            {t(
                                                'outward.govtRiceOutward.form.fields.gunnyOld'
                                            )}
                                        </FormLabel>
                                        <FormControl>
                                            <Input
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel>
                                            {t(
                                                'outward.govtRiceOutward.form.fields.juteWeight'
                                            )}
                                        </FormLabel>
                                        <FormControl>
                                            <Input
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel>
                                            {t(
                                                'outward.govtRiceOutward.form.fields.truckNo'
                                            )}
                                        </FormLabel>
                                        <FormControl>
                                            <Input
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel>
                                            {t(
                                                'outward.govtRiceOutward.form.fields.truckRst'
                                            )}
                                        </FormLabel>
                                        <FormControl>
                                            <Input
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel>
                                            {t(
                                                'outward.govtRiceOutward.form.fields.truckWeight'
                                            )}
                                        </FormLabel>
                                        <FormControl>
                                            <Input
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel>
                                            {t(
                                                'outward.govtRiceOutward.form.fields.gunnyWeight'
                                            )}
                                        </FormLabel>
                                        <FormControl>
                                            <Input
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel>
                                            {t(
                                                'outward.govtRiceOutward.form.fields.netWeight'
                                            )}
                                        </FormLabel>
                                        <FormControl>
                                            <Input
                        ...
                        <DialogFooter>
                            ...
                            <Button type='submit'>
                                {isEditing
                                    ...
                                    : t(
                                          'outward.govtRiceOutward.form.primaryButton'
                                      )}
                            </Button>
                        </DialogFooter>
                    </form>
