...
import { getSilkyKodhaOutwardColumns } from './silky-kodha-outward-columns'
...
export function SilkyKodhaOutwardTable({
    ...
    const columns = useMemo(() => getSilkyKodhaOutwardColumns(t), [t])
    ...
    return (
        ...
        >
            ...
            <SilkyKodhaOutwardMultiDeleteDialog
