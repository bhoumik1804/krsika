...
import { PrivatePaddyOutwardMultiDeleteDialog } from './private-paddy-outward-multi-delete-dialog'
...
export function DataTableBulkActions<TData>({
    ...
    const handleBulkStatusChange = (status: 'completed' | 'cancelled') => {
        const selectedRecords = selectedRows.map(
            (row) => row.original as PrivatePaddyOutward
        )
    ...
    return (
        <>
            ...
            <PrivatePaddyOutwardMultiDeleteDialog
                table={table}
