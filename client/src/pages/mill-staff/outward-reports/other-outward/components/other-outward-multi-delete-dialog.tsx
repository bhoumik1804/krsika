...
import { useBulkDeleteOtherOutward } from '../data/hooks'
import { type OtherOutward } from '../data/schema'

type OtherOutwardMultiDeleteDialogProps = {
...
export function OtherOutwardMultiDeleteDialog({
    table,
    open,
    onOpenChange,
    millId,
}: OtherOutwardMultiDeleteDialogProps) {
    const selectedRows = table.getFilteredSelectedRowModel().rows
    const bulkDeleteMutation = useBulkDeleteOtherOutward(millId)
