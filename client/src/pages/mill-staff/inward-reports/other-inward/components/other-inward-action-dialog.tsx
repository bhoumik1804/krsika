        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className='max-h-[90vh] max-w-2xl overflow-y-auto'>
                <DialogHeader>
                    <DialogTitle>
                        {isEditing
                            ? t('otherInward.editRecord')
                            : t('otherInward.addRecord')}
                    </DialogTitle>
                    <DialogDescription>
                        {isEditing ? t('common.updating') : t('common.adding')}
                    </DialogDescription>
                </DialogHeader>
                <Form {...form}>
                    <form
                        ...
                        <div className='grid grid-cols-2 gap-4'>
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel>
                                            {t(
                                                'otherInward.form.otherPurchaseDealNumber'
                                            )}
                                        </FormLabel>
                                        <FormControl>
                                            <PaginatedCombobox
                                                ...
                                                placeholder={t(
                                                    'otherInward.form.searchDeal'
                                                )}
                                                emptyText={t(
                                                    'otherInward.form.noDealsFound'
                                                )}
                                            />
                                        </FormControl>
                                        <FormMessage />
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel>
                                            {t('otherInward.form.itemName')}
                                        </FormLabel>
                                        <FormControl>
                                            <Input
                                                placeholder={t(
                                                    'otherInward.form.enterItemName'
                                                )}
                                                {...field}
                                                value={field.value || ''}
                                            />
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel>
                                            {t('otherInward.form.partyName')}
                                        </FormLabel>
                                        <FormControl>
                                            <Input
                                                placeholder={t(
                                                    'otherInward.form.enterPartyName'
                                                )}
                                                {...field}
                                                value={field.value || ''}
                                            />
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel>
                                            {t('otherInward.form.brokerName')}
                                        </FormLabel>
                                        <FormControl>
                                            <Input
                                                placeholder={t(
                                                    'otherInward.form.enterBrokerName'
                                                )}
                                                {...field}
                                                value={field.value || ''}
                                            />
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel>
                                            {t('otherInward.form.gunnyPlastic')}
                                        </FormLabel>
                                        <FormControl>
                                            <Input
                                                type='number'
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel>
                                            {t(
                                                'otherInward.form.juteGunnyWeight'
                                            )}
                                        </FormLabel>
                                        <FormControl>
                                            <Input
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel>
                                            {t(
                                                'otherInward.form.plasticGunnyWeight'
                                            )}
                                        </FormLabel>
                                        <FormControl>
                                            <Input
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel>
                                            {t('otherInward.form.truckNumber')}
                                        </FormLabel>
                                        <FormControl>
                                            <Input
                                                placeholder={t(
                                                    'otherInward.form.enterTruckNo'
                                                )}
                                                {...field}
                                                value={field.value || ''}
                                            />
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel>
                                            {t('otherInward.form.rstNumber')}
                                        </FormLabel>
                                        <FormControl>
                                            <Input
                                                placeholder={t(
                                                    'otherInward.form.enterRstNo'
                                                )}
                                                {...field}
                                                value={field.value || ''}
                                            />
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel>
                                            {t('otherInward.form.truckWeight')}
                                        </FormLabel>
                                        <FormControl>
                                            <Input
                                                type='number'
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel>
                                            {t('otherInward.form.gunnyWeight')}
                                        </FormLabel>
                                        <FormControl>
                                            <Input
                                                type='number'
