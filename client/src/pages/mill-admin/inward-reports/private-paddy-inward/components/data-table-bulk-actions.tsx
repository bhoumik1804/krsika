...
import { PrivatePaddyInwardMultiDeleteDialog } from './private-paddy-inward-multi-delete-dialog'
...
export function DataTableBulkActions<TData>({
    ...
    const handleBulkStatusChange = (status: 'completed' | 'cancelled') => {
        const selectedRecords = selectedRows.map(
            (row) => row.original as PrivatePaddyInward
        )
    ...
    return (
        <>
            ...
            <PrivatePaddyInwardMultiDeleteDialog
                table={table}
