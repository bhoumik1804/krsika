...
import { FinancialPaymentMultiDeleteDialog } from './financial-payment-multi-delete-dialog'
...
export function DataTableBulkActions<TData>({
    ...
    const handleBulkStatusChange = (status: 'completed' | 'cancelled') => {
        const selectedRecords = selectedRows.map(
            (row) => row.original as FinancialPayment
        )
    ...
    return (
        <>
            ...
            <FinancialPaymentMultiDeleteDialog
                table={table}
