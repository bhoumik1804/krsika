...
import { CommitteeReportMultiDeleteDialog } from './committee-report-multi-delete-dialog'
...
export function DataTableBulkActions<TData>({
    ...
    const handleBulkStatusChange = (status: 'completed' | 'cancelled') => {
        const selectedRecords = selectedRows.map(
            (row) => row.original as CommitteeReportData
        )
    ...
    return (
        <>
            ...
            <CommitteeReportMultiDeleteDialog
                table={table}
