...
import { CommitteeReportDialogs } from './components/committee-report-dialogs'
import { CommitteeReportPrimaryButtons } from './components/committee-report-primary-buttons'
import {
    CommitteeReportProvider,
    useCommitteeReport,
} from './components/committee-report-provider'
    ...
    return (
        ...
        >
            ...
            <Main className='flex flex-1 flex-col gap-4 sm:gap-6'>
                ...
                <CommitteeReportContent navigate={navigate} />
            </Main>

            <CommitteeReportDialogs />
        </CommitteeReportProvider>
    )
}

// Separate component to use context hook
function CommitteeReportContent({
    navigate,
}: {
