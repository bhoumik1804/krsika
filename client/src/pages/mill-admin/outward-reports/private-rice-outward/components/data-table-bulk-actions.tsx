...
import { PrivateRiceOutwardMultiDeleteDialog } from './private-rice-outward-multi-delete-dialog'
...
export function DataTableBulkActions<TData>({
    ...
    const handleBulkStatusChange = (status: 'completed' | 'cancelled') => {
        const selectedRecords = selectedRows.map(
            (row) => row.original as PrivateRiceOutward
        )
    ...
    return (
        <>
            ...
            <PrivateRiceOutwardMultiDeleteDialog
                table={table}
