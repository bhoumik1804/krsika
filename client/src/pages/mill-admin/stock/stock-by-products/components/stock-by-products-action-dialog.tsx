...
import { stockByProductsSchema, type StockByProducts } from '../data/schema'

type StockByProductsActionDialogProps = {
    open: boolean
    onOpenChange: (open: boolean) => void
    currentRow: StockByProducts | null
}

export function StockByProductsActionDialog({
    open,
    onOpenChange,
    currentRow,
}: StockByProductsActionDialogProps) {
    const isEditing = !!currentRow
    const [datePopoverOpen, setDatePopoverOpen] = useState(false)

    const form = useForm<StockByProducts>({
        resolver: zodResolver(stockByProductsSchema),
        defaultValues: {
            date: '',
            partyName: '',
            vehicleNumber: '',
