...
import { stockRiceSchema, type StockRice } from '../data/schema'

type StockRiceActionDialogProps = {
    open: boolean
    onOpenChange: (open: boolean) => void
    currentRow: StockRice | null
}

export function StockRiceActionDialog({
    open,
    onOpenChange,
    currentRow,
}: StockRiceActionDialogProps) {
    const isEditing = !!currentRow
    const [datePopoverOpen, setDatePopoverOpen] = useState(false)

    const form = useForm<StockRice>({
        resolver: zodResolver(stockRiceSchema),
        defaultValues: {
            date: '',
            partyName: '',
            vehicleNumber: '',
