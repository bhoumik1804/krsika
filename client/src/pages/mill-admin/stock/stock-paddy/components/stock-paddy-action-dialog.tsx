...
import { stockPaddySchema, type StockPaddy } from '../data/schema'

type StockPaddyActionDialogProps = {
    open: boolean
    onOpenChange: (open: boolean) => void
    currentRow: StockPaddy | null
}

export function StockPaddyActionDialog({
    open,
    onOpenChange,
    currentRow,
}: StockPaddyActionDialogProps) {
    const isEditing = !!currentRow
    const [datePopoverOpen, setDatePopoverOpen] = useState(false)

    const form = useForm<StockPaddy>({
        resolver: zodResolver(stockPaddySchema),
        defaultValues: {
            date: '',
            partyName: '',
            vehicleNumber: '',
