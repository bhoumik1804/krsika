...
import { stockGunnyOtherSchema, type StockGunnyOther } from '../data/schema'

type StockGunnyOtherActionDialogProps = {
    open: boolean
    onOpenChange: (open: boolean) => void
    currentRow: StockGunnyOther | null
}

export function StockGunnyOtherActionDialog({
    open,
    onOpenChange,
    currentRow,
}: StockGunnyOtherActionDialogProps) {
    const isEditing = !!currentRow
    const [datePopoverOpen, setDatePopoverOpen] = useState(false)

    const form = useForm<StockGunnyOther>({
        resolver: zodResolver(stockGunnyOtherSchema),
        defaultValues: {
            date: '',
            partyName: '',
            vehicleNumber: '',
