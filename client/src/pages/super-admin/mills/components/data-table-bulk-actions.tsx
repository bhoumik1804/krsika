...
type DataTableBulkActionsProps<TData extends Mill> = {
    table: Table<TData>
}

export function DataTableBulkActions<TData extends Mill>({
    table,
